# leaflet-challenge
Earthquake Data Visualization - Technical Documentation
...
D3.js - Fetch and manipulate JSON data
...
Uses D3.js to fetch live earthquake data from USGS API:
...
Size: Proportional to the earthquake magnitude (scaled up for visibility).

function getRadius(magnitude) {
  return magnitude ? magnitude * 5 : 1;
}

Color: Based on earthquake depth (third coordinate in geometry.coordinates).
...
Popup on Click: Shows Location, Magnitude, and Depth.
